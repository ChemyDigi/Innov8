  ...
  return (
    <section className="py-16 bg-[#F5F5F1]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Heading */}
        <h2 className="
          text-3xl md:text-4xl font-semibold text-gray-900 mb-12
        ...
        ">
          ...
          <div className="text-center md:text-justify">
            <p className="text-lg text-gray-700 leading-relaxed">
              INNOV8 was founded in 2020 with a commitment to delivering solutions
              that transcend traditional technology. We are an agile organization
              powered by a strong engineering team, equipped to help you tackle modern
              challenges and uncover new growth opportunities.
            </p>
          </div>
