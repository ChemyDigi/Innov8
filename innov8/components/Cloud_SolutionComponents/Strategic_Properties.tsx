  ...
  const priorities = [
    {
      ...
      description:
        "Building a secure and compliant foundation from the start, integrating governance and security controls directly into your cloud-native architecture.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {priorities.map((priority, index) => (
            <div
              key={index}
              className="bg-[#F5F6F1] border border-gray-200 h-96 overflow-hidden"
            >
