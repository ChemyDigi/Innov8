  ...
  return (
    <section className="relative pt-10 pb-2 bg-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mb-14 text-justify">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-black">
            ...
            <p className="text-gray-700 text-justify leading-relaxed">
                ...
                ensuring your cloud environment is safe and optimized from the start.
            </p>
            </div>
            ...
            <p className="text-gray-700 text-justify leading-relaxed">
                Cloud Platform Implementation, Application Modernization & Migration, 
                DevOps/DevSecOps Pipeline Setup, Continuous Optimization.
            </p>
