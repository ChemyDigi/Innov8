...
export default function Subsidiaries() {
  return (
    <section className="relative w-full py-16 px-40 mx-auto bg-white font-montserrat">
      <h2 className="text-3xl font-bold text-red-600 mb-6">Our Subsidiaries</h2>
      ...
      <div className="mt-12 bg-[#F5F5F1] rounded-lg flex flex-col md:flex-row gap-6">
        ...
        <div className = "p-6">
          <h3 className="text-xl font-semibold mb-3 text-black">Our Subsidiaries</h3>
          ...
          <a href="#" className="text-red-600 mt-4 block font-medium">
            Discover more
          </a>
        </div>
      </div>
