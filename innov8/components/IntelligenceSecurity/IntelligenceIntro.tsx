  ...
  return (
    <section className="w-full bg-white py-24 px-6 md:px-16 lg:px-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1.8fr_1fr] gap-16 items-start">
        {/* COLUMN 1 — Heading */}
        <div>
          <h2 className="text-1xl md:text-2xl font-semibold text-black leading-tight mb-8 text-justify tracking-tight">
            Intelligent Continuous Security with Help Innov8’s Expertise.
          </h2>

          <p className="text-lg text-black leading-relaxed text-justify tracking-tight">
        ...
        <div>
          ...
          <p className="text-lg text-black leading-relaxed pt-8 text-justify tracking-tight">
